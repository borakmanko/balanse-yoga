            ...
            <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
                <div className="max-w-md w-full">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-3xl font-semibold text-white mb-3 drop-shadow-lg">Welcome back</h1>
                        <p className="text-white/90 text-lg drop-shadow-md">Sign in to continue your yoga journey</p>
                    </div>
