...
const ProfileEdit: React.FC<ProfileEditProps> = ({
  ...
  const handleArrayToggle = (field: string, value: string) => {
    const [parent, child] = field.split(".");
    const currentArray =
      (formData[parent as keyof UserProfile] as any)?.[child] || [];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Update user profile and get the updated profile back
      const updatedProfile = await updateUserProfile(user.uid, updatedData);
  ...
  return (
    <div className=" inset-50 z-50 flex items-center justify-center">
      <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-auto flex flex-col">
        {/* Header */}
              ...
              <div className="mt-4">
                ...
                {formData.gender === "other" && (
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("customGender", e.target.value)
                    }
                  ...
                  <div className="flex flex-wrap gap-2">
                    {yogaTypes.map((type) => (
                      <button
                        ...
                        type="button"
                        onClick={() =>
                          handleArrayToggle("preferences.yogaTypes", type)
                        }
                  ...
                  <div className="flex flex-wrap gap-2">
                    {goals.map((goal) => (
                      <button
                        ...
                        type="button"
                        onClick={() =>
                          handleArrayToggle("preferences.goals", goal)
                        }
                        className={`px-3 py-1 rounded-full text-sm transition-all ${
